...
var age = prompt("Age!?")
var city = prompt("And City!?")
console.log("My Name is " + name + ", Im " + age + " years Old, and I live in " + city + "!")
< My Name is Java, Im 29 years Old, and I live in Mocha!
//10. Create an alert that uses the response from a prompt.
var response = prompt("How about them Broncos!?")
​alert(response)
< Awesome!
